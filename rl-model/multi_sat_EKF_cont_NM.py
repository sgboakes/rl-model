...
if __name__ == "__main__":
    ...
    if save_check == ('y' or 'Y'):
        ...
        df_reward.to_csv('SAC-Reward-Returns-5.csv')
        ...
        df_cov.to_csv('SAC-Covariance-Returns-5.csv')
        ...
        df_cov_fin.to_csv('SAC-Covariance-Fin-Returns-5.csv')
